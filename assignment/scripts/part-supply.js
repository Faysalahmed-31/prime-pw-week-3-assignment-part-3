...
console.log('4. Removed item:', supplyChanges[supplyChanges.length-1]);
console.log('4. Removed item (BONUS): ', supplyChanges.pop());
...
let sumOfArray = 0;
for(let i=0; i<supplyChanges.length; i++){
sumOfArray +=supplyChanges[i];
}
console.log('9. Total supplies available is:', sumOfArray );
